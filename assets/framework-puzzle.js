...
(function () {
  ...
  var TIER_CONTENT = {
    founder: {
      ...
      5: "<p>Bring a real decision — a bet, a launch, or receipts you can't read clearly. Thirty minutes to trace it through the four moves.</p>"
    },
    operator: {
      ...
      5: "<p>Bring one stuck decision — pricing, hiring shape, a channel that won't compound. Thirty minutes, four moves, written down.</p>"
    },
    architect: {
      ...
      5: "<p>Bring one decision under load — a system choice, a scaling bet, a constraint you can't model cleanly. Thirty minutes, four moves, traced on the page.</p>"
    }
  };
  ...
  function init(root) {
    ...
    function initReel() {
      ...
      var m = window.location.hash && window.location.hash.match(/frame-([1-5])/);
      if (m) {
